            ...
            <div className="relative h-full w-full z-10 mx-auto py-12 sm:py-20">
                <div className="h-full w-full">
                    ...
                    <div className="h-full flex flex-col items-center justify-center text-white text-center px-5">
                        ...
                        <h3 className="text-xl sm:text-1xl md:text-2xl md:leading-tight font-semibold mb-4">Detergente Sulfonato de Calcio Sintético (Booster TBN)</h3>
                            ...
                            <table className="w-full rtl:text-right text-zinc-500 dark:text-white">
                                ...
                                <tbody>
                                    <tr className="bg-white border-b dark:bg-zinc-800 dark:border-zinc-300 border-zinc-500">
                                        ...
                                        <td className="px-6 py-3">
                                            Líquido viscoso, castaño rojizo y transparente
                                        </td>
                                    </tr>
                                    <tr className="bg-white border-b dark:bg-zinc-800 dark:border-zinc-300 border-zinc-500">
                                        <td className="px-6 py-3">
                        ...
                        <p className="mx-auto max-w-xl md:px-5">
                            <ul className="list-disc pl-5">
                                ...
                                <li>La temperatura de almacenamiento no debe exceder los 45 ° C.</li>
