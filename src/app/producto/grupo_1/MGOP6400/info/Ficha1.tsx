            ...
            <div className="relative h-full w-full z-10 mx-auto py-12 sm:py-20">
                <div className="h-full w-full">
                    ...
                    <div className="h-full flex flex-col items-center justify-center text-white text-center px-5">
                        ...
                        <h3 className="text-xl sm:text-1xl md:text-2xl md:leading-tight font-semibold mb-4">Paquete de Aditivos para Aceites de Motor a Diesel</h3>
                            ...
                            <table className="w-full rtl:text-right text-zinc-500 dark:text-white">
                                ...
                                <tbody>
                                    <tr className="bg-white border-b dark:bg-zinc-800 dark:border-zinc-300 border-zinc-500">
                                        <td className="px-6 py-3">CF-4/SG</td>
                                        <td className="px-6 py-3">6%</td>
                                        <td className="px-6 py-3">CD/SD</td>
                                        <td className="px-6 py-3">2.8%</td>
                                    </tr>
                                    <tr className="bg-white border-b dark:bg-zinc-800 dark:border-zinc-300 border-zinc-500">
                                        <td className="px-6 py-3">CF/SF</td>
                                        <td className="px-6 py-3">4.2%</td>
                                        <td className="px-6 py-3">SD/CC</td>
                                        <td className="px-6 py-3">2.7%</td>
                                    </tr>
                                    <tr className="bg-white border-b dark:bg-zinc-800 dark:border-zinc-300 border-zinc-500">
                                        <td className="px-6 py-3">SF/CD</td>
                                        <td className="px-6 py-3">3.5%</td>
                                        <td className="px-6 py-3">CC/SC</td>
                                        <td className="px-6 py-3">2.5%</td>
                                    </tr>
                                    <tr className="bg-white border-b dark:bg-zinc-800 dark:border-zinc-300 border-zinc-500">
                                        <td className="px-6 py-3">CD</td>
                                        <td className="px-6 py-3">2.6%(Grado Único)</td>
                                        <td className="px-6 py-3">SB/CB</td>
                                        <td className="px-6 py-3">1.6%</td>
                                    </tr>
                                </tbody>
                            </table>
                        </div>
                        <p className="mx-auto max-w-5xl md:px-5">Este producto se recomienda formularse con aceites base Grupo I y II se puede combinar con motores de gasolina o diésel con diferentes grados de viscosidad, cubriendo los 5W-30, 10W-30, 10W-40, 15W-40, 20W-50, 40 y 50, etc.</p>
                        <div className="relative overflow-x-auto shadow-md rounded-2xl text-xl max-w-5xl mx-auto mb-4 md:px-5">
                            <table className="w-full rtl:text-right text-zinc-500 dark:text-white">
                                <thead className="text-zinc-700 uppercase bg-gray-50 dark:bg-zinc-700 dark:text-white">
                                    <tr>
                                ...
                                <tbody>
                                    ...
                                    <tr className="bg-white border-b dark:bg-zinc-800 dark:border-zinc-300 border-zinc-500">
                                        ...
                                        <td className="px-6 py-3">1019 - 1059</td>
                                        <td className="px-6 py-3">1039</td>
                                    </tr>
                                    <tr className="bg-white border-b dark:bg-zinc-800 dark:border-zinc-300 border-zinc-500">
                                    ...
                                    <tr className="bg-white border-b dark:bg-zinc-800 dark:border-zinc-300 border-zinc-500">
                                        ...
                                        <td className="px-6 py-3">226</td>
                                    </tr>
                                    <tr className="bg-white border-b dark:bg-zinc-800 dark:border-zinc-300 border-zinc-500">
                                        <td className="px-6 py-3">Número Total de Base, (mg KOH/g)</td>
                                        <td className="px-6 py-3">D2896</td>
                                        <td className="px-6 py-3">155 - 181</td>
                                        <td className="px-6 py-3">168</td>
                                    </tr>
                                    <tr className="bg-white border-b dark:bg-zinc-800 dark:border-zinc-300 border-zinc-500">
                                        <td className="px-6 py-3">Contenido de Ca, % peso</td>
                                        <td className="px-6 py-3">D4951</td>
                                        <td className="px-6 py-3">5.35 - 6.53</td>
                                        <td className="px-6 py-3">5.94</td>
                                    </tr>
                                    <tr className="bg-white border-b dark:bg-zinc-800 dark:border-zinc-300 border-zinc-500">
                                        <td className="px-6 py-3">Contenido de P, % peso</td>
                                        <td className="px-6 py-3">D4951</td>
                                        <td className="px-6 py-3">1.48 - 1.80</td>
                                        <td className="px-6 py-3">1.64</td>
                                    </tr>
                                    <tr className="bg-white border-b dark:bg-zinc-800 dark:border-zinc-300 border-zinc-500">
                                        <td className="px-6 py-3">Contenido de N, % peso</td>
                                        <td className="px-6 py-3">D5762</td>
                                        <td className="px-6 py-3">0.46 - 0.62</td>
                                        <td className="px-6 py-3">0.54</td>
                                    </tr>
                                </tbody>
                            </table>
                        </div>
