                            ...
                            <table className="w-full rtl:text-right text-zinc-500 dark:text-white">
                                ...
                                <tbody>
                                    <tr className="bg-white border-b dark:bg-zinc-800 dark:border-zinc-300 border-zinc-500">
                                        <td className="px-6 py-3">API SP, ILSAC GF-6</td>
                                        <td className="px-6 py-3">0W-20, 0W-30, 5W-20, 5W-30, 10W-30, <br/>10W-40, 15W-40, 20W-50, etc</td>
                                        <td className="px-6 py-3">7.68%</td>
                                    </tr>
                                </tbody>
                            </table>
                        </div>
                            ...
                            <table className="w-full rtl:text-right text-zinc-500 dark:text-white">
                                ...
                                <tbody>
                                    ...
                                    <tr className="bg-white border-b dark:bg-zinc-800 dark:border-zinc-300 border-zinc-500">
                                        ...
                                        <td className="px-6 py-3">104</td>
                                    </tr>
                                    <tr className="bg-white border-b dark:bg-zinc-800 dark:border-zinc-300 border-zinc-500">
                                        <td className="px-6 py-3">Densidad @20 ℃, kg/m3 </td>
                                        <td className="px-6 py-3">D4052</td>
                                        <td className="px-6 py-3">954 - 994</td>
                                        <td className="px-6 py-3">974</td>
                                    </tr>
                                    <tr className="bg-white border-b dark:bg-zinc-800 dark:border-zinc-300 border-zinc-500">
                                    ...
                                    <tr className="bg-white border-b dark:bg-zinc-800 dark:border-zinc-300 border-zinc-500">
                                        ...
                                        <td className="px-6 py-3">0103 - 127</td>
                                        <td className="px-6 py-3">115</td>
                                    </tr>
                                    <tr className="bg-white border-b dark:bg-zinc-800 dark:border-zinc-300 border-zinc-500">
                                        <td className="px-6 py-3">Contenido de Ca, % peso </td>
                                        <td className="px-6 py-3">D4951</td>
                                        <td className="px-6 py-3">1.22 - 1.50</td>
                                        <td className="px-6 py-3">1.36</td>
                                    </tr>
                                    <tr className="bg-white border-b dark:bg-zinc-800 dark:border-zinc-300 border-zinc-500">
                                        <td className="px-6 py-3">Contenido de Zn, % peso</td>
                                        <td className="px-6 py-3">D4951</td>
                                        <td className="px-6 py-3">0.97 - 1.19</td>
                                        <td className="px-6 py-3">1.08</td>
                                    </tr>
                                    <tr className="bg-white border-b dark:bg-zinc-800 dark:border-zinc-300 border-zinc-500">
                                        <td className="px-6 py-3">Contenido de P, % peso</td>
                                        <td className="px-6 py-3">D4951</td>
                                        <td className="px-6 py-3">0.85 - 1.05</td>
                                        <td className="px-6 py-3">0.95</td>
                                    </tr>
                                    <tr className="bg-white border-b dark:bg-zinc-800 dark:border-zinc-300 border-zinc-500">
                                        <td className="px-6 py-3">Contenido de N, % peso</td>
                                        <td className="px-6 py-3">D5291</td>
                                        <td className="px-6 py-3">1.18 - 1.60</td>
                                        <td className="px-6 py-3">1.39</td>
                                    </tr>
                                    <tr className="bg-white border-b dark:bg-zinc-800 dark:border-zinc-300 border-zinc-500">
                                        <td className="px-6 py-3">Contenido de Mg, % peso</td>
                                        <td className="px-6 py-3">D4951</td>
                                        <td className="px-6 py-3">0.72 - 0.88</td>
                                        <td className="px-6 py-3">0.80</td>
                                    </tr>
                                    <tr className="bg-white border-b dark:bg-zinc-800 dark:border-zinc-300 border-zinc-500">
                                        <td className="px-6 py-3">Ceniza de Sulfato, % peso</td>
                                        <td className="px-6 py-3">D874</td>
                                        <td className="px-6 py-3">Reportar</td>
                                        <td className="px-6 py-3">9.86</td>
                                    </tr>
