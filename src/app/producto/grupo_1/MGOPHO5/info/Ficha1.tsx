            ...
            <div className="relative h-full w-full z-10 mx-auto py-12 sm:py-20">
                <div className="h-full w-full">
                    ...
                    <div className="h-full flex flex-col items-center justify-center text-white text-center px-5">
                        ...
                        <h3 className="text-xl sm:text-1xl md:text-2xl md:leading-tight font-semibold mb-4">Paquete de Aditivos para Aceites Hidráulicos Anti Desgaste</h3>
                        ...
                        <div className="relative overflow-x-auto shadow-md rounded-2xl text-xl max-w-5xl mx-auto mb-4 md:px-5">
                            <table className="w-full rtl:text-right text-zinc-500 dark:text-white">
                                <thead className="text-zinc-700 uppercase bg-gray-50 dark:bg-zinc-700 dark:text-white">
                                    <tr>
                                        <th className="px-6 py-3">Grado de Viscosidad</th>
                                ...
                                <tbody>
                                    <tr className="bg-white border-b dark:bg-zinc-800 dark:border-zinc-300 border-zinc-500">
                                        <td className="px-6 py-3">22，32，46，68，100</td>
                            ...
                            <table className="w-full rtl:text-right text-zinc-500 dark:text-white">
                                ...
                                <tbody>
                                    <tr className="bg-white border-b dark:bg-zinc-800 dark:border-zinc-300 border-zinc-500">
                                        ...
                                        <td className="px-6 py-3">Líquido amarillo transparente</td>
                                    </tr>
                                    <tr className="bg-white border-b dark:bg-zinc-800 dark:border-zinc-300 border-zinc-500">
                                    ...
                                    <tr className="bg-white border-b dark:bg-zinc-800 dark:border-zinc-300 border-zinc-500">
                                        <td className="px-6 py-3">Viscosidad Cinemática @40 °C, mm²/s</td>
                                    ...
                                    <tr className="bg-white border-b dark:bg-zinc-800 dark:border-zinc-300 border-zinc-500">
                                        ...
                                        <td className="px-6 py-3">15.042 °C</td>
                                    </tr>
                                    <tr className="bg-white border-b dark:bg-zinc-800 dark:border-zinc-300 border-zinc-500">
                        ...
                        <p className="mx-auto max-w-xl md:px-5">
                            <ul className="list-disc pl-5">
                                <li>Envasado en tambores de acero a 200 Lt.</li>
                                ...
                                <li>Al momento de almacenar y mezclar, no es flamable, ni explosivo, ni corrosivo. Es igual a los demás productos derivados del petróleo en términos de seguridad, protección ambiental, eso y otros aspectos. No requiere protección especial.</li>
                            </ul>
                        </p>
