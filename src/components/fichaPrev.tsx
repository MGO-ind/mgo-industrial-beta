...
const FichaInfoPrev: React.FC<FichaInfoPrevProps> = ({ PrevFichas }) => {
    return (
    <>
        <a href={PrevFichas.btnHref} className="block max-w-sm mt-2 p-6 bg-white border border-gray-200 rounded-lg shadow-sm hover:bg-gray-100 dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-700 hover:shadow-lg transition-shadow duration-300">
